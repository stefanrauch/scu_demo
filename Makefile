...
scu_demo.elf: irq.o crt0.o main.o dev/uart.o dev/mprintf.o dev/sockitowm/crcutil.o dev/sockitowm/owerr.o dev/sockitowm/ownet.o dev/sockitowm/owtran.o dev/sockitowm/owlnk.o dev/sockitowm/findtype.o dev/sockitowm/temp42.o dev/sockitowm/eep43.o	
